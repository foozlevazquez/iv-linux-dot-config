function Options(){
  ...
  function cleanUpOldOptions() {
    ...
    if (Persistent.get("localStoragePurged")) localStoragePurged = true;

    for (var i in localStorage) {
      if (!/^gmailTooltip/.test(i) && !/pdfTooltipShown$/.test(i) && !/turnedOffSearchHelper$/.test(i)) {
    ...
    if (localStoragePurged)
      Persistent.set("localStoragePurged", localStoragePurged);
